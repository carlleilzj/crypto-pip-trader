...
class PassedConfig:
    ...
    def _from_dict(cls, d: dict[str, Any]) -> PassedConfig:
        ...
        return cls(
            ...
            stop_pct=_f(stop_pct, None) if stop_pct is not None else None,
            trail_arm=_f(trail_arm, None) if trail_arm is not None else None,
            trail_giveback=_f(trail_giveback, None) if trail_giveback is not None else None,
